...
import { AIMessageChunk, AIMessage, ChatMessage, isAIMessage, } from "@langchain/core/messages";
 ...
 * ```
 */
export class BedrockChat extends BaseChatModel {
    get lc_aliases() {
        return {
            model: "model_id",
            region: "region_name",
    ...
    constructor(fields) {
        ...
        Object.defineProperty(this, "_anthropicTools", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
